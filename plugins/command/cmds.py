...
def start(_,m):
    ...
    Client.send_photo(_,chat_id=m.chat.id,photo='https://i.ibb.co/XxN0rMyq/file-UTS9k-P8-Dot-Wrw-Vd-Es-Apv-Dq-1.webp',caption=f"""<a href=https://t.me/Deep_Chk/3">↯</a> » 𝘽𝙞𝙚𝙣𝙫𝙚𝙣𝙞𝙙𝙤 𝘿𝙚𝙚𝙥𝘾𝙃𝙆 1.6 >_ 
